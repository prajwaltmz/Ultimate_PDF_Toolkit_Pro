...
--------------------------------------------------------------------
* Ultimate_PDF_Toolkit_Pro.py: 
  The main Python source code containing all features (PDF/Word merge, split, convert, encrypt, OCR/preview). (Keep it: YES)

* setup_wizard.py: 
  The Python source code that designs the Graphical Setup Wizard window. This wraps the core app into a beautiful installer. (Keep it: YES)

* build_installer.bat: 
  1-Click Windows batch script. When you make changes to the code and double-click this script, it automatically recompiles everything into Ultimate_PDF_Toolkit_Pro_Setup.exe right in this same folder. It also places a copy in the Executable_Packages folder. (Keep it: YES)

* requirements.txt: 
  Lists the required Python libraries needed to build and run the app from source. (Keep it: YES)

* README.md & README.txt: 
  The complete user manual, feature breakdown, and installation guide. (Keep it: YES)

* .gitignore: 
  Tells Git to ignore temporary compiler caches and large binaries when pushing to GitHub or other repositories. (Keep it: YES)
...
- Rotate PDF: Rotate PDF pages (90, 180, 270 degrees).
...
--------------------------------------------------------------------
Developer Guide (Compiling & Building From Source)
--------------------------------------------------------------------
